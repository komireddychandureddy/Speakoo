...
var tutors_module_1 = require("./modules/tutors/tutors.module");
var bookings_module_1 = require("./modules/bookings/bookings.module");
var sessions_module_1 = require("./modules/sessions/sessions.module");
...
var feedback_module_1 = require("./modules/feedback/feedback.module");
var admin_module_1 = require("./modules/admin/admin.module");
var global_jwt_auth_guard_1 = require("./modules/auth/guards/global-jwt-auth.guard");
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    isGlobal: true,
                    envFilePath: [
                        ".env.".concat((_a = process.env.NODE_ENV) !== null && _a !== void 0 ? _a : 'development'),
                        '.env',
                    ],
                }),
            ...
            providers: [
                { provide: core_1.APP_GUARD, useClass: global_jwt_auth_guard_1.GlobalJwtAuthGuard },
