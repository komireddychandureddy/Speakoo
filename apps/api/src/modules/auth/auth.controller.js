...
var REFRESH_COOKIE = 'speakoo_refresh';
var COOKIE_MAX_AGE_MS = 30 * 24 * 60 * 60 * 1000; // 30 days
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        function AuthController_1(authService, jwt, config) {
            this.authService = (__runInitializers(this, _instanceExtraInitializers), authService);
            this.jwt = jwt;
            this.config = config;
        }
        AuthController_1.prototype.register = function (dto, res) {
            return __awaiter(this, void 0, void 0, function () {
                var tokens;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.register(dto)];
                        case 1:
                            tokens = _a.sent();
                            this.setRefreshCookie(res, tokens.refreshToken);
                            return [2 /*return*/, { accessToken: tokens.accessToken }];
                    }
                });
            });
        };
        AuthController_1.prototype.login = function (dto, res) {
            return __awaiter(this, void 0, void 0, function () {
                var tokens;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AuthController_1.prototype.refresh = function (req, res) {
            return __awaiter(this, void 0, void 0, function () {
                var refreshToken, payload, tokens;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            refreshToken = (_a = req.cookies) === null || _a === void 0 ? void 0 : _a[REFRESH_COOKIE];
                            if (!refreshToken) {
                            ...
                            return [4 /*yield*/, this.authService.refresh(payload.sub)];
                        case 1:
                            tokens = _b.sent();
                            this.setRefreshCookie(res, tokens.refreshToken);
                            return [2 /*return*/, { accessToken: tokens.accessToken }];
    ...
    (function () {
        ...
        _register_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('register'), openapi.ApiResponse({ status: 201 })];
        _login_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), openapi.ApiResponse({ status: common_1.HttpStatus.OK })];
        _refresh_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('refresh'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), openapi.ApiResponse({ status: common_1.HttpStatus.OK })];
        _logout_decorators = [(0, common_1.Post)('logout'), (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT), openapi.ApiResponse({ status: common_1.HttpStatus.NO_CONTENT })];
